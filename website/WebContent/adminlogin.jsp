...
body {
	background: #DCDDDF url(Images/a.png);
	color: #000;
	font: 14px Arial;
	margin: 0 auto;
	padding: 0;
...
#content form input[type="password"] 
{
	...
	background: #eae7e7 url(Images/b.png) no-repeat;
  ...
  <div class="container">
	<section id="content">
		<form method="post"  action="check.jsp">
			<h1>Admin Login </h1>
			<div>
				<input type="text" placeholder="Admin Id"  id="username" name="n1" value="" />
			</div>
			<div>
				<input type="password" placeholder="Password"  id="password" name="n2" value="" />
			</div>
			<div>
				<input type="submit" value="Log in" name="b1" onclick="return f1(n1),f2(n2)" />
