...
sql=("select img_name from images where img_name like '%"+s1+"%' or format like '%"+s1+"%' or img_type like '%"+s1+"%' limit 12,17 ");
...
%><div align="center"><a href="index1.jsp">Back</a>&nbsp;&nbsp;<%
boolean x=rs.last();

if(x!=false && count==18)
{
%>|&nbsp;&nbsp;<a href="index3.jsp?=<%=count%>">Next</a></div><% }
else
...
<%
	...
	int count=12;
	sql=("select img_name from images order by  upload_date desc limit 12,17 ");
