<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.sql.*" import="java.io.*,java.util.*"%>
...
String checker="a";
session.setAttribute("normal",checker); %>
<a href="index.jsp"><b>HOME</b></a>
<a href="index.jsp"><h2>Artist Exclusive</h2></a><h5 align="center">(A Poster's Exclusive)</h5>
		<div class="rain">
			...
			<div class="border start">
				<form method="post"  action="check.jsp">
					...
					<input name="n1" placeholder="Email" value="" type="text" />
					<label for="n2">Password</label>
					<input name="n2" placeholder="Password" value="" type="password"/>
					&nbsp;&nbsp;<a href="forgot.jsp">Forgot Password</a><br><br><h4 align="right"><a href="Signup.jsp">Not a User? Sign up Now!</a></h4>
					<br>
                                       <center> <input name="b1" type="submit" value="LOG IN" onclick="return f1(n1),f2(n2)"/></center>
				</form>
			</div>
		</div>
